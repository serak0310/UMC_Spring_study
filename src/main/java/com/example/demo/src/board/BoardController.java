...
public class BoardController {
    ...
    public BaseResponse<List<GetBoardRes>> getBoards(@RequestParam(required = false) String boardName) {
        ...
        try {
            ...
            List<GetBoardRes> getBoardsRes = boardProvider.getBoardsByBoardname(boardName);
            return new BaseResponse<>(getBoardsRes);
        } catch (BaseException exception) {
            return new BaseResponse<>((exception.getStatus()));
        }
